...
An enhanced **openFrameworks** (aka OF) desktop application that creates organic, animated visualizations from text using customizable shapes, colors, and animations with mouse interactions.
